...
import 'package:admin_app/controller/order/archived_orders_controller.dart';
...
class ArchivedOrdersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("68".tr, style: Theme.of(context).textTheme.headlineLarge),
        centerTitle: true,
        elevation: 0,
      ),
      body: GetBuilder<ArchivedOrdersControllerImp>(
        builder: (controller) {
         ...
         else if (controller.archivedOrders.isEmpty && controller.statusRequest == StatusRequest.success) {
            return Center(
              child: Text(
                "71".tr,
